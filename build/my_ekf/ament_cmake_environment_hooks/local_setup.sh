...
: ${AMENT_CURRENT_PREFIX:="/opt/my_workspace/ros2-slam-ekf-application/ros2_ws/install/my_ekf"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_ekf/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_ekf/environment/path.sh"
